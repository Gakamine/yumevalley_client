    ...
    <section>
        <b-table
            ...
            <template slot-scope="props">
                ...
                <b-table-column field="id" label="ID" width="30" sortable numeric>
                    {{ props.row.id }}
                </b-table-column>

                <b-table-column field="user.first_name" label="Cover">
                ...
                <b-table-column field="date" label="Date" width="100" sortable centered>
